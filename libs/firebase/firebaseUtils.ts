...
import {getFcmToken} from "../../utils/misc/fcmTokenUtils";
import * as admin from "firebase-admin";

import {SocketNotification} from "../websocket/socketManager";

export const sendFcmMessage = (uid, notification: SocketNotification) => {
...
const sendFirebaseMessage = async (fcmTokens, notification: SocketNotification) => {
    ...
    const response = await Messaging.sendToDevice(fcmTokens, payload, options);
